...
Game::Game(unsigned short (&array)[22][22])
{
	...
	std::cout << "ѕроходимость g_wall при инициализации карты в конструкторе: " << g_wall.getPassability() << std::endl;
	std::cout << "ѕроходимость нул€ при инициализации карты в конструкторе g_wall'ом: " << dmap[0][0]->getPassability() << std::endl;
